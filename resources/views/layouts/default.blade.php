    ...
    <header class="text-gray-600">
        <div class="container mx-auto flex justify-between items-center p-5 items-center">
            <a href="/" class="flex title-font font-medium items-center text-gray-900">
                ...
                <span class="ml-3 text-xl">Minha loja Virtual</span>
            </a>
...
<footer class="text-gray-600">
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">© 2022 Casarini —
                <!-- <a href="https://twitter.com/knyttneve" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer"></a> -->@API
            </p>
            <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">API Desenvolvida em Laravel</span>
        </div>
    </div>
</footer>
